 ...
 *
 * @method ArtistQuery leftJoinSong($relationAlias = null) Adds a LEFT JOIN clause to the query using the Song relation
 * @method ArtistQuery rightJoinSong($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Song relation
 * @method ArtistQuery innerJoinSong($relationAlias = null) Adds a INNER JOIN clause to the query using the Song relation
 *
...
abstract class BaseArtistQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'radio-hipster', $modelName = 'RH\\Model\\Artist', $modelAlias = null)
    {
    ...
    public function filterBySong($song, $comparison = null)
    {
        if ($song instanceof Song) {
            return $this
                ->addUsingAlias(ArtistPeer::ID, $song->getArtistId(), $comparison);
