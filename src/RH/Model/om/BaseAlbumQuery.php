...
abstract class BaseAlbumQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'radio-hipster', $modelName = 'RH\\Model\\Album', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name` FROM `album` WHERE `id` = :p0';
        try {
    ...
    public function filterBySong($song, $comparison = null)
    {
        if ($song instanceof Song) {
            return $this
                ->addUsingAlias(AlbumPeer::ID, $song->getAlbumId(), $comparison);
