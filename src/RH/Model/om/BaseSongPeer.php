...
abstract class BaseSongPeer
{
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(SongPeer::ID) && $criteria->keyContainsValue(SongPeer::ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(SongPeer::ID);
            $value = $criteria->remove(SongPeer::ID);
            if ($value) {
                $selectCriteria->add(SongPeer::ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(SongPeer::ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(SongPeer::DATABASE_NAME);
            $criteria->add(SongPeer::ID, $pks, Criteria::IN);
